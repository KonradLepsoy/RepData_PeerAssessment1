...
**The mean number of steps taken per day is `r my_mean` and the median number of steps taken per day is `r my_median`.**
...
**The interval with the max number of steps is `r max_steps`.**
